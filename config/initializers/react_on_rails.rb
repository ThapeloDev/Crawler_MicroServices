...
ReactOnRails.configure do |config|
  ...
  config.npm_build_production_command = "bundle && npm i && (sh -c 'rm app/assets/webpack/* || true && cd client && 
         bundle exec rake react_on_rails:locale && yarn run build:production')"
